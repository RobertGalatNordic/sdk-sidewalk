...
static void app_btn_dfu_state(uint32_t unused)
{
	...
	application_state_working(&global_state_notifier, !go_to_dfu_state);
...
{
	button_set_action_short_press(DK_BTN1, app_btn_send_msg, 0);
	button_set_action_long_press(DK_BTN1, app_btn_dfu_state, 0);
	button_set_action_short_press(DK_BTN2, app_btn_connect, 0);
	button_set_action_long_press(DK_BTN2, app_btn_factory_reset, 0);
	button_set_action(DK_BTN3, app_btn_link_switch, 0);
